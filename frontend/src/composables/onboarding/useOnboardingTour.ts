...
import { usePersistedRef, parseBoolish, serializeBoolish } from '@/composables/shared/usePersistedRef'
...
export const ONBOARDING_STEPS: readonly OnboardingStep[] = [
  ...
  // Reviews tab is that home now, and the step points at it.
  {
    id: 'coaching',
    heading: 'Reviews',
    body: 'Review your own matches the way a coach would — Review my last session opens the film room right here, or pick the matches yourself. Send matches to a coach and read what comes back, or open a bundle a player sent you and coach them. The whole cycle lives under Reviews; a coach\'s loaned matches never join your history.',
    target: '#tab-reviews',
    placement: 'bottom',
  },
