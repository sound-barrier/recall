...
} from '@/composables/onboarding/useOnboardingTour'
...
import TourCallout from '@/components/onboarding/TourCallout.vue'
  ...
  <transition name="onboarding-fade">
    ...
    >
      ...
      <TourCallout
        ...
        :counter="counter"
        :step-count="tour.totalSteps"
        :step-index="tour.stepNumber.value - 1"
        :can-back="!tour.isFirstStep.value"
        :is-last="tour.isLastStep.value"
        @jump="(i: number) => tour.goToStep(i)"
        @back="onBack"
        @next="onNext"
        @skip="onSkip"
        @finish="onFinish"
