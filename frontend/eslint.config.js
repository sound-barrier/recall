...
export default tseslint.config(
  ...
  // not 'warn' — lint:js runs --max-warnings 0.
  {
    files: [
      ...
      'src/components/elo/EloMythChecks.vue',
      'src/components/elo/EloResultsPanel.vue',
      'src/components/elo/elo-verdict.ts',
      ...
      'src/composables/matches/useDetailPanelKeyboard.ts',
      ...
      'src/composables/matches/useMatchesDossierQueries.ts',
      ...
      'src/composables/matches/useTableSort.ts',
      ...
      'src/match/elo-changepoint.ts',
      'src/match/elo-lift.ts',
      'src/match/elo-seed.test.ts',
      'src/match/elo-seed.ts',
      'src/match/elo-simulate.ts',
      'src/match/elo-stats.ts',
      'src/match/elo-streaks.ts',
      'src/match/match-form-slices.ts',
      'src/match/match-group-helpers.ts',
      'src/match/match-hero-pool-helpers.ts',
      'src/match/match-markdown.ts',
      'src/match/match-momentum-helpers.ts',
      'src/match/match-overrides.ts',
      'src/match/match-stats-helpers.ts',
      'src/match/match-table-tsv.ts',
      'src/match/match-time-helpers.ts',
      'src/match/match-trends-helpers.ts',
      'src/match/pivot-aggregate.ts',
