...
SHELL_SCRIPTS := $(wildcard scripts/lib/*.sh scripts/db/*.sh scripts/ci/*.sh scripts/stack/*.sh) $(wildcard scripts/release/*.sh) $(wildcard scripts/release/smoke/*.sh) initialize.sh .devcontainer/postCreate.sh
