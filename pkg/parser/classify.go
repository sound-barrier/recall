...
// parser populated. Returns one of "rank" / "summary" / "scoreboard" /
// "personal" / "unknown".
//
// Order is load-bearing: a SCOREBOARD parse populates BOTH the E/A/D
...
// scoreboard with a populated panel as "personal".
//
