...
func isAllHeroesScreenshot(img image.Image, work string) (bool, error) {
	bounds := img.Bounds()
	...
	return strings.Contains(upper, "HERO DAMAGE") || strings.Contains(upper, "DAMAGE MITIGATED"), nil
}
