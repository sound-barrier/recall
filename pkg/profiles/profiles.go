...
// through the Profiles type for mutation. (An `immutable` sidecar list used
// to live here for the tour's read-only sample; the sample is a writable
// sandbox now, and a lingering key in an older profiles.json is simply
