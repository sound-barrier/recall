...
var sentinels = []sentinel{
	...
	{"ErrInvalidExclusionReason", app.ErrInvalidExclusionReason, "invalid exclusion reason: must be 'placement', 'mmr_adjustment', or 'outage'"},
...
func carvedSentinels() []carvedSentinel {
	return []carvedSentinel{
		...
		{"ErrInvalidExclusionReason", app.ErrInvalidExclusionReason, matchedit.ErrInvalidExclusionReason},
		...
		{"ErrDuplicateHeroPosition", app.ErrDuplicateHeroPosition, matchedit.ErrDuplicateHeroPosition},
