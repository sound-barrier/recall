...
> `assets.go`, `cmd/bug-finder`, `cmd/roster-watch`, `cmd/seed-dev`,
> `cmd/update-signing` — are covered by a pointer rule scoped to `**/*.go`,
> because a nested file cannot reach them.
