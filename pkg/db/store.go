...
// ──────────────────────────────────────────────────────────────────────
// Hidden matches — user-curated soft delete. Presence in the table IS
// the hidden state; we never store a boolean. Hide/Unhide are idempotent
// — hiding an already-hidden key updates the timestamp; unhiding a
// non-hidden key is a no-op.
// ──────────────────────────────────────────────────────────────────────
