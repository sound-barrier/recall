...
func TestResolveMatchKey_MultiHero_TeamsSwapAdoptsSummary(t *testing.T) {
	...
	key, _ := correlate.ResolveMatchKey("Overwatch 2 Screenshot 2026.07.15 - 14.00.30 _sb.png", teams, snap)
...
func TestResolveMatchKey_MultiHero_SecondPersonalAdoptsMatch(t *testing.T) {
	...
	key, _ := correlate.ResolveMatchKey("Overwatch 2 Screenshot 2026.07.20 - 14.01.15 _p2.png", personal2, snap)
...
func TestResolveMatchKey_MultiHero_ReverseOrder_SummaryBridgesToTeams(t *testing.T) {
	...
	key, _ := correlate.ResolveMatchKey("Overwatch 2 Screenshot 2026.07.15 - 14.00.30 _sum.png", summary, snap)
	if key != "match-2026-07-15T14-00-00" {
