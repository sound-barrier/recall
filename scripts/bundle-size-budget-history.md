...
|---|---|---|---|---|---|---|
| 2026-06-08 | ui-polish-set | 156000 | 60000 | 440000 | 245000 | UI polish set (items 3 / 4 / 5 / 6 / 7 / 8 / 10 / 12 from UI_RECOMMENDATIONS.md): TypeaheadDropdown + inline tag autocomplete + bulk-tag + extended right-click menu + leaf hover preview + smart-empty suggestions + saved-set presets + supported-formats surface + re-parse progress. Combined ~20 KB JS + ~3 KB CSS. |
